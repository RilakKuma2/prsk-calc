...
const AmatsuyuTab = ({ surveyData, setSurveyData }) => {
  ...
  const rewardTable = [
    ...
    { level: 25, rewards: { '생일 칭호': '기본 3', '작캔': 3, '중급 스킬북': 1, '전용 메모리얼': 1 } },
    ...
    { level: 70, rewards: { '생일 칭호': '날개 2', '작캔': 5, '중급 스킬북': 1, '전용 메모리얼': 1 } },
    ...
    { level: 165, rewards: { '생일 칭호': '꽃 1', '작캔': 7, '중급 스킬북': 1, '전용 메모리얼': 2 } },
    ...
    { level: 300, rewards: { '생일 칭호': '꽃 3', '작캔': 7, '중급 스킬북': 1, '전용 메모리얼': 3 } },
