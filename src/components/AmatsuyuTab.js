      ...
      <div className="w-[85%] max-w-[340px] mx-auto space-y-4">
        ...
        <div className="flex justify-center gap-2">
          ...
          <button
            ...
            className={`flex items-center justify-center w-10 h-10 rounded-full transition-colors border ${(notifySettings.enabled || notifySettings.discordWebhook || notifySettings.telegramChatId) ? 'bg-purple-100 text-purple-600 border-purple-200' : 'bg-gray-50 text-gray-400 border-gray-200 hover:bg-gray-100'}`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
