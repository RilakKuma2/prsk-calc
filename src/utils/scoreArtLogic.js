import { mySekaiTableData, powerColumnThresholds } from '../data/mySekaiTableData';
...
export const MY_SEKAI_POWERS = powerColumnThresholds;

export const MY_SEKAI_REQ_MULTIPLIERS = mySekaiTableData;
