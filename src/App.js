      ...
      {currentTab !== 'talks' && (
        <>
          <div className="button-container relative">
            <button className="calc-save-load-button px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-lg shadow-md transition-all duration-200" onClick={saveData}>{t('app.save')}</button>
            <button className="calc-save-load-button px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-lg shadow-md transition-all duration-200" onClick={loadData}>{t('app.load')}</button>
          </div>
            ...
            <div className="absolute bottom-full mb-2 right-0 w-72 bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-xl border border-gray-100 text-sm text-gray-600 leading-relaxed z-[60] animate-fade-in text-left flex flex-col gap-3">
              ...
              <div className="space-y-1">
                ...
                <a href="https://github.com/xfl03/sekai-calculator" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-1.5 -mx-1 rounded-lg hover:bg-gray-50 text-gray-600 hover:text-indigo-600 transition-colors group">
                  ...
                  <span className="text-xs font-medium border-b border-transparent group-hover:border-indigo-600 truncate">xfl03/sekai-calculator</span>
                </a>
              </div>
